...
- (void)requestFromSever{
    ...
    NSArray *data = @[@{@"uid":@"1",@"nickname":@"阿猫",@"picurl":@"http://xiuxin-1253234316.costj.myqcloud.com/giftImages/header.png"},@{@"uid":@"2",@"nickname":@"阿猪",@"picurl":@"http://xiuxin-1253234316.costj.myqcloud.com/giftImages/header.png"}];
