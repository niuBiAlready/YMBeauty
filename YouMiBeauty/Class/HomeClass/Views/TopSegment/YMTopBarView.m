...
-(void)initData{
    ...
    if (_titles.count<MAX_TitleNumInWindow+1) {
        _btn_w=SCREEN_WIDTH/_titles.count;
    }else{
    ...
    _titleSelectColor=PinkTextColor;
}
...
-(CGFloat)getlineWidth:(NSInteger )strIndex{
    ...
    CGFloat lineW = [firstStr widthWithFont:_titleFont constrainedToHeight:self.frame.size.height-2]+4+20;
